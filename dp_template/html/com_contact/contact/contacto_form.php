		...
		<fieldset>
			...
			<?php if ($this->params->get('show_email_copy')) : ?>
				<div class="control-group copia">
					<div class="control-label" style="float:right;"><?php echo $this->form->getLabel('contact_email_copy'); ?></div>
					<div class="controls" style="float:left;"><?php echo $this->form->getInput('contact_email_copy'); ?></div>
				</div>
			<?php endif; ?>

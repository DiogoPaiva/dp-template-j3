...
<div class="mapa">
{mosmap width='100%'
<?php echo "|lat='".$this->params->get('mapa_latitude')."'|lon='".$this->params->get('mapa_longitude')."'" ?>
<?php echo "|icon='". $this->baseurl ."/templates/dp_template/images/".$this->params->get('mapa_icon')."'|styledmap='".$this->params->get('mapa_json')."'" ?>
} 
</div>
